...
typedef ImmT  generator_c_struct_dependence_sort0result_t0type;

typedef ImmT  generator_c_struct_dependence_sort0result_element0type;

typedef ImmT  generator_c_struct_dependence_sort0graph_node0type;

typedef ImmT  generator_c_struct_dependence_sort0graph0type;

typedef ImmT  generator_c_struct_dependence_sort0sorted_element0type;

typedef ImmT  generator_c_struct_dependence_sort0decl_def_type0type;
