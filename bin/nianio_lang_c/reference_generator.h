...
#include "ptd.h"
#include "nast.h"
typedef ImmT  reference_generator0fun_ref0type;

typedef ImmT  reference_generator0module0type;

typedef ImmT  reference_generator0refs0type;

typedef ImmT  reference_generator0deref_type0type;

typedef ImmT  reference_generator0ref_type0type;
